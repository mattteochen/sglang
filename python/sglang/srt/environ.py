...
class Envs:
    ...
    SGLANG_EXPERIMENTAL_COMPILE_DEEPSEEK_PREFILL_LAYER = EnvBool(False)
    SGLANG_EXPERIMENTAL_COMPILE_DEEPSEEK_PREFILL_LAYER_GROUP_SIZE = EnvInt(1)
    SGLANG_EXPERIMENTAL_COMPILE_DEEPSEEK_PREFILL_LAYER_WARMUP_STEPS = EnvInt(0)
    SGLANG_EXPERIMENTAL_COMPILE_DEEPSEEK_PREFILL_MODEL = EnvBool(False)
    SGLANG_EXPERIMENTAL_COMPILE_DEEPSEEK_PREFILL_MODEL_WARMUP_STEPS = EnvInt(0)
    SGLANG_EXPERIMENTAL_COMPILE_DEEPSEEK_PREFILL_SKIP_GUARD_EVAL_UNSAFE = EnvBool(
        False
    )
    SGLANG_EXPERIMENTAL_COMPILE_DEEPSEEK_PREFILL_DISABLE_MLP_BF16_GEMMS = EnvBool(
        False
    )
    SGLANG_EXPERIMENTAL_COMPILE_DEEPSEEK_PREFILL_NESTED_COMPILE_REGION = EnvBool(
        False
    )
